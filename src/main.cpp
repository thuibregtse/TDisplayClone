...
#define LED_YELLOW CLK_OUT1
#define LED_GREEN CLK_OUT2
...
*/
        ...
        tft.drawCentreString("6969", 80, 30, 4); // Draw text centre at position 80, 24 using font 4

        tft.drawCentreString("12.34", 80, 54, 6); // Draw text centre at position 80, 24 using font 6

        tft.drawCentreString("12.34 is in font size 6", 80, 92, 8); // Draw text centre at position 80, 90 using font 2
